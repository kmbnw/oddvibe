...
namespace oddvibe {
    ...
    class CachedSampler: public Sampler {
        public:
            CachedSampler(Sampler& sampler, const size_t& nrows);
             ...
             * counts[10]++; counts[11]++;
             *
             * @param[inout] A sample index count accumulator.  Must be the
             * same size as nrows this Sampler was constructed
             * from.
             */
            void add_counts(std::vector<unsigned int>& counts);
